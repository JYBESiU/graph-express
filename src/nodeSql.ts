...
async function getCityNodes(sql: Sql) {
...
async function getCompanyNodes(sql: Sql) {
  const nodes = await sql`
...
async function getContinentNodes(sql: Sql) {
  const nodes = await sql`
...
async function getCountryNodes(sql: Sql) {
  const nodes = await sql`
...
async function getForumNodes(sql: Sql) {
  const nodes = await sql`
...
async function getMessageNodes(sql: Sql) {
  const nodes = await sql`
...
async function getPersonNodes(sql: Sql) {
  const nodes = await sql`
...
async function getTagclassNodes(sql: Sql) {
  const nodes = await sql`
...
async function getUniversityNodes(sql: Sql) {
  const nodes = await sql`
